...
w_b__i_b_tilde = w_b__i_b_tilde_uncal;

%% Plot raw IMU data
plot_IMU(w_b__i_b_tilde, f_b__i_b_tilde, constants);

%% Self-alignment
accel_q = mean(f_b__i_b_tilde(:,1000:8000)');
gyro_q = mean(w_b__i_b_tilde(:,1000:8000)');
...
for ii=1:length(f_b__i_b_tilde) - 100
